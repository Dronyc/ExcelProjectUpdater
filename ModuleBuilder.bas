...
ws.Cells.Clear
    ...
    For c = 1 To tCount
        cL = colLetter(1 + c)
        ws.Cells(5, 1 + c).formula = "=COUNTIFS(тблПроекты[Дата создания],""<> "",тблПроекты[Тип проекта],""" & projectTypes(c - 1) & """)"
        ws.Cells(6, 1 + c).formula = "=COUNTIFS(тблПроекты[Дата создания],""<> "",тблПроекты[Тип проекта],""" & projectTypes(c - 1) & """,тблПроекты[Число ошибок],0)"
        ws.Cells(7, 1 + c).formula = "=COUNTIFS(тблПроекты[Дата создания],""<> "",тблПроекты[Тип проекта],""" & projectTypes(c - 1) & """,тблПроекты[Число ошибок],"" >0"")"
        ws.Cells(8, 1 + c).formula = "=IF(" & cL & "5=0,""""," & cL & "6/" & cL & "5)"
        ws.Cells(9, 1 + c).formula = "=COUNTIFS(тблПроекты[Дата создания],""<> "",тблПроекты[Тип проекта],""" & projectTypes(c - 1) & """,тблПроекты[Проект закрыт],TRUE)"
        ws.Cells(10, 1 + c).formula = "=COUNTIFS(тблПроекты[Дата создания],""<> "",тблПроекты[Тип проекта],""" & projectTypes(c - 1) & """,тблПроекты[Проект закрыт],TRUE,тблПроекты[Число ошибок],"" >0"")"
    ...
    For c = 1 To tCount
        cL = colLetter(1 + c)
        ws.Cells(rowT2 + 2, 1 + c).formula = "=COUNTIFS(тблПроекты[Дата создания],""<>"",тблПроекты[Тип проекта],""" & projectTypes(c - 1) & """,тблПроекты[Группа ПГС],""да"",тблПроекты[Группа PLM],"""")"
        ws.Cells(rowT2 + 3, 1 + c).formula = "=COUNTIFS(тблПроекты[Дата создания],""<>"",тблПроекты[Тип проекта],""" & projectTypes(c - 1) & """,тблПроекты[Группа ПГС],""да"",тблПроекты[Группа PLM],"""",тблПроекты[Число ошибок],0)"
        ws.Cells(rowT2 + 4, 1 + c).formula = "=COUNTIFS(тблПроекты[Дата создания],""<>"",тблПроекты[Тип проекта],""" & projectTypes(c - 1) & """,тблПроекты[Группа ПГС],""да"",тблПроекты[Группа PLM],"""",тблПроекты[Число ошибок],"">0"")"
        ws.Cells(rowT2 + 5, 1 + c).formula = "=IF(" & cL & (rowT2 + 2) & "=0,""""," & cL & (rowT2 + 3) & "/" & cL & (rowT2 + 2) & ")"
        ws.Cells(rowT2 + 6, 1 + c).formula = "=COUNTIFS(тблПроекты[Дата создания],""<>"",тблПроекты[Тип проекта],""" & projectTypes(c - 1) & """,тблПроекты[Группа ПГС],""да"",тблПроекты[Группа PLM],"""",тблПроекты[Проект закрыт],TRUE)"
        ws.Cells(rowT2 + 7, 1 + c).formula = "=COUNTIFS(тблПроекты[Дата создания],""<>"",тблПроекты[Тип проекта],""" & projectTypes(c - 1) & """,тблПроекты[Группа ПГС],""да"",тблПроекты[Группа PLM],"""",тблПроекты[Проект закрыт],TRUE,тблПроекты[Число ошибок],"">0"")"
    ...
    For c = 1 To tCount
        cL = colLetter(1 + c)
        ws.Cells(rowT3 + 2, 1 + c).formula = "=COUNTIFS(тблПроекты[Дата создания],""<>"",тблПроекты[Тип проекта],""" & projectTypes(c - 1) & """,тблПроекты[Группа PLM],""да"",тблПроекты[Группа ПГС],"""")"
        ws.Cells(rowT3 + 3, 1 + c).formula = "=COUNTIFS(тблПроекты[Дата создания],""<>"",тблПроекты[Тип проекта],""" & projectTypes(c - 1) & """,тблПроекты[Группа PLM],""да"",тблПроекты[Группа ПГС],"""",тблПроекты[Число ошибок],0)"
        ws.Cells(rowT3 + 4, 1 + c).formula = "=COUNTIFS(тблПроекты[Дата создания],""<>"",тблПроекты[Тип проекта],""" & projectTypes(c - 1) & """,тблПроекты[Группа PLM],""да"",тблПроекты[Группа ПГС],"""",тблПроекты[Число ошибок],"">0"")"
        ws.Cells(rowT3 + 5, 1 + c).formula = "=IF(" & cL & (rowT3 + 2) & "=0,""""," & cL & (rowT3 + 3) & "/" & cL & (rowT3 + 2) & ")"
        ws.Cells(rowT3 + 6, 1 + c).formula = "=COUNTIFS(тблПроекты[Дата создания],""<>"",тблПроекты[Тип проекта],""" & projectTypes(c - 1) & """,тблПроекты[Группа PLM],""да"",тблПроекты[Группа ПГС],"""",тблПроекты[Проект закрыт],TRUE)"
        ws.Cells(rowT3 + 7, 1 + c).formula = "=COUNTIFS(тблПроекты[Дата создания],""<>"",тблПроекты[Тип проекта],""" & projectTypes(c - 1) & """,тблПроекты[Группа PLM],""да"",тблПроекты[Группа ПГС],"""",тблПроекты[Проект закрыт],TRUE,тблПроекты[Число ошибок],"">0"")"
    ...
    For c = 1 To tCount
        cL = colLetter(1 + c)
        ws.Cells(rowT4a + 2, 1 + c).formula = "=COUNTIFS(тблПроекты[Дата создания],""<>"",тблПроекты[Тип проекта],""" & projectTypes(c - 1) & """,тблПроекты[Группа ПГС],""да"",тблПроекты[Группа PLM],""да"")"
        ws.Cells(rowT4a + 3, 1 + c).formula = "=COUNTIFS(тблПроекты[Дата создания],""<>"",тблПроекты[Тип проекта],""" & projectTypes(c - 1) & """,тблПроекты[Группа ПГС],""да"",тблПроекты[Группа PLM],""да"",тблПроекты[Число ошибок],0)"
        ws.Cells(rowT4a + 4, 1 + c).formula = "=COUNTIFS(тблПроекты[Дата создания],""<>"",тблПроекты[Тип проекта],""" & projectTypes(c - 1) & """,тблПроекты[Группа ПГС],""да"",тблПроекты[Группа PLM],""да"",тблПроекты[Число ошибок],"">0"")"
        ws.Cells(rowT4a + 5, 1 + c).formula = "=IF(" & cL & (rowT4a + 2) & "=0,""""," & cL & (rowT4a + 3) & "/" & cL & (rowT4a + 2) & ")"
        ws.Cells(rowT4a + 6, 1 + c).formula = "=COUNTIFS(тблПроекты[Дата создания],""<>"",тблПроекты[Тип проекта],""" & projectTypes(c - 1) & """,тблПроекты[Группа ПГС],""да"",тблПроекты[Группа PLM],""да"",тблПроекты[Проект закрыт],TRUE)"
        ws.Cells(rowT4a + 7, 1 + c).formula = "=COUNTIFS(тблПроекты[Дата создания],""<>"",тблПроекты[Тип проекта],""" & projectTypes(c - 1) & """,тблПроекты[Группа ПГС],""да"",тблПроекты[Группа PLM],""да"",тблПроекты[Проект закрыт],TRUE,тблПроекты[Число ошибок],"">0"")"
    ...
    For c = 1 To tCount
        cL = colLetter(1 + c)
        ws.Cells(rowT4b + 2, 1 + c).formula = "=COUNTIFS(тблПроекты[Дата создания],""<>"",тблПроекты[Тип проекта],""" & projectTypes(c - 1) & """,тблПроекты[Группа ПГС],"""",тблПроекты[Группа PLM],"""")"
        ws.Cells(rowT4b + 3, 1 + c).formula = "=COUNTIFS(тблПроекты[Дата создания],""<>"",тблПроекты[Тип проекта],""" & projectTypes(c - 1) & """,тблПроекты[Группа ПГС],"""",тблПроекты[Группа PLM],"""",тблПроекты[Число ошибок],0)"
        ws.Cells(rowT4b + 4, 1 + c).formula = "=COUNTIFS(тблПроекты[Дата создания],""<>"",тблПроекты[Тип проекта],""" & projectTypes(c - 1) & """,тблПроекты[Группа ПГС],"""",тблПроекты[Группа PLM],"""",тблПроекты[Число ошибок],"">0"")"
        ws.Cells(rowT4b + 5, 1 + c).formula = "=IF(" & cL & (rowT4b + 2) & "=0,""""," & cL & (rowT4b + 3) & "/" & cL & (rowT4b + 2) & ")"
        ws.Cells(rowT4b + 6, 1 + c).formula = "=COUNTIFS(тблПроекты[Дата создания],""<>"",тблПроекты[Тип проекта],""" & projectTypes(c - 1) & """,тблПроекты[Группа ПГС],"""",тблПроекты[Группа PLM],"""",тблПроекты[Проект закрыт],TRUE)"
        ws.Cells(rowT4b + 7, 1 + c).formula = "=COUNTIFS(тблПроекты[Дата создания],""<>"",тблПроекты[Тип проекта],""" & projectTypes(c - 1) & """,тблПроекты[Группа ПГС],"""",тблПроекты[Группа PLM],"""",тблПроекты[Проект закрыт],TRUE,тблПроекты[Число ошибок],"">0"")"
